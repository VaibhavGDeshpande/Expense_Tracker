...
import 'package:first/split_func.dart';
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SplitScreen()), // Replace SplitFunctionScreen with the desired destination page
                        );
                      },
                      child: const Text('Go to Split Function'),
                    ),
                    const SizedBox(height: 20.0),
                  ],
                ),
